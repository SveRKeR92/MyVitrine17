...
define( 'DB_NAME', 'sverker_myvitrine' ); //myvitrine_db

/** Utilisateur de la base de données MySQL. */
define( 'DB_USER', 'sverker' ); //root

/** Mot de passe de la base de données MySQL. */
define( 'DB_PASSWORD', 'b~c3]Fe,gTgM' ); // ''

/** Adresse de l’hébergement MySQL. */
define( 'DB_HOST', 'mysql-sverker.alwaysdata.net' ); //localhost
